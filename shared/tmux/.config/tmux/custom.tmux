#!/usr/bin/env bash
#===============================================================================
#   Config based in tmux-power.conf
#===============================================================================
...
tmux_set window-status-format         "#[fg=$G0,bg=$G2]$rarrow#[fg=$TC,bg=$G2] #(basename #{pane_current_path}) #[fg=$G2,bg=$G0]$rarrow"
tmux_set window-status-current-format "#[fg=$G0,bg=$TC]$rarrow#[fg=$G0,bg=$TC,bold] #I:#W#F - #(basename #{pane_current_path}) #[fg=$TC,bg=$G0,nobold]$rarrow"
